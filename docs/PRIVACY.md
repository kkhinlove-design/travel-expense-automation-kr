...
- PDF/HWPX 추출에 성공하면 누락 점검용 출장대장을 만들기 위해 구조화된 출장 정보와 선택한 원본을 기관의 비공개 Supabase Storage에 자동 등록합니다.
- 자동 등록된 건은 `작성 필요`, 최종 서류 저장을 마친 건은 `서류 완료` 상태로 구분하며 본인 계정에서만 조회·삭제할 수 있습니다.
