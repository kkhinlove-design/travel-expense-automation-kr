...
| 운영 | 이메일/비밀번호 로그인 · 개인별 기본 출발 기준지 · 직원 계정 생성·편집·Excel 등록 · 공용 운임 Excel/Google 시트 등록 · 사용자별 저장·삭제 · 원본 보관 |
...
- 사용자가 **저장**할 때만 구조화된 출장 정보와 선택한 원본 PDF/HWPX가 자신의 Supabase 프로젝트로 전송·보관됩니다.
