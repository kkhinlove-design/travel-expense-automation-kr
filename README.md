...
| 운영 | 이메일/비밀번호 로그인 · 개인별 기본 출발 기준지 · 직원 계정 생성·편집·Excel 등록 · 공용 운임 Excel/Google 시트 등록 · 승인/완료 출장대장 · 사용자별 저장·삭제 · 원본 보관 |
...
- PDF/HWPX 추출에 성공하면 누락 점검을 위해 구조화된 출장 정보와 선택한 원본이 자신의 Supabase 프로젝트에 `작성 필요` 상태로 자동 등록됩니다. 최종 저장 후에는 같은 기록이 `서류 완료`로 전환됩니다.
